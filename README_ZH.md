...
FinAgent 是一个开源的 A 股智能投研助理，基于 [Nanobot](https://github.com/HKUDS/nanobot) 轻量级 AI Agent 框架构建。支持 **Telegram、Discord、WhatsApp、微信、飞书、钉钉、Slack** 等多个消息平台。
...
- Python 3.11+
- 一个 LLM API Key（支持 DeepSeek / OpenCode / MiniMax / 通义千问 / OpenRouter）
- 一个机器人账号（见下方支持的平台）
...
| **微信** | 扫码登录（`nanobot channels login weixin`） |
...
| **OpenCode** | 多种模型 | `https://api.opencode.ai/v1` |
| **MiniMax** | MiniMax 系列 | `https://api.minimax.chat/v1` |
| **通义千问** | qwen-plus, qwen-max | `https://dashscope.aliyuncs.com/compatible-mode/v1` |
| **OpenRouter** | 100+ 模型 | `https://openrouter.ai/api/v1` |
